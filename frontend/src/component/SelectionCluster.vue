...
export default {
  ...
  methods: {
    ...
    getChildrenContent(data, resolve) {
      ...
      switch (data.level) {
        case 1:
          this.$http.post('http://localhost:5000/dataShow/getIndicatorName', params).then(res => {
        ...
        case 2:
          ...
          this.$http.post('http://localhost:5000/dataShow/getNodeIP', params).then(res => {
        ...
        case 3:
          ...
          this.$http.post('http://localhost:5000/dataShow/getNodeName', params).then(res => {
        ...
        case 4:
          ...
          this.$http.post('http://localhost:5000/dataShow/getDiskName', params).then(res => {
